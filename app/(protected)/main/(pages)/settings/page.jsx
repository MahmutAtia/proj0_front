                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex justify-content-between align-items-center">
                        <div className="flex align-items-center gap-3">
                            <Avatar
                                label={session?.user?.name?.charAt(0) || 'U'}
                                size="large"
                                            ...
                                            {currentSubscription?.has_subscription ? (
                                                <div>
                                                    <div className="flex justify-content-between align-items-start mb-4">
                                                        ...
                                                        <Badge
                                                            value={currentSubscription.is_canceling ? 'ENDING SOON' : currentSubscription.status.toUpperCase()}
                                                    ...
                                                    <Card className={`${currentSubscription.is_canceling ? 'bg-orange-50 border-orange-200' : 'bg-green-50 border-green-200'} mb-4`}>
                                                        <div className="grid align-items-center">
                                                            <div className="col-12 md:col-8">
                                                                <h4 className="text-xl font-bold mb-2">{currentSubscription.plan?.name}</h4>
                                                                <p className="text-600 mb-2">
                                                                    <i className="pi pi-dollar mr-2"></i>
                                                                    ${currentSubscription.plan?.price} per {currentSubscription.plan?.billing_period}
                                                                </p>
                                                                <p className="text-600 mb-2">
                                            ...
                                            <div className="flex flex-column gap-4">
                                                <div className="flex align-items-center justify-content-between p-3 border-1 border-200 border-round">
                                                    <div className="flex-1">
                                                        <h5 className="font-semibold mb-1">Product Updates & News</h5>
                                                        <p className="text-600 text-sm">Get notified about new features and product announcements</p>
                                                    </div>
                                                    <InputSwitch
                                                        checked={notifications.emailUpdates}
                                                        onChange={(e) => setNotifications(prev => ({ ...prev, emailUpdates: e.value }))}
                                                    />
                                                </div>

                                                <div className="flex align-items-center justify-content-between p-3 border-1 border-200 border-round">
                                                    <div className="flex-1">
                                                        <h5 className="font-semibold mb-1">Plan Expiry Notifications</h5>
                                                        <p className="text-600 text-sm">Receive alerts before your subscription expires</p>
                                                    </div>
                                                    <InputSwitch
                                                        checked={notifications.planExpiry}
                                                        onChange={(e) => setNotifications(prev => ({ ...prev, planExpiry: e.value }))}
                                                    />
                                                </div>

                                                <div className="flex align-items-center justify-content-between p-3 border-1 border-200 border-round">
                                                    <div className="flex-1">
                                                        <h5 className="font-semibold mb-1">Usage Alerts</h5>
                                                        <p className="text-600 text-sm">Get notified when you're approaching feature limits</p>
                                                    </div>
                                                    <InputSwitch
                                                        checked={notifications.usageAlerts}
                                                        onChange={(e) => setNotifications(prev => ({ ...prev, usageAlerts: e.value }))}
                                                    />
                                                </div>

                                                <div className="flex align-items-center justify-content-between p-3 border-1 border-200 border-round">
                                                    <div className="flex-1">
                                                        <h5 className="font-semibold mb-1">Promotions & Offers</h5>
                                                        <p className="text-600 text-sm">Receive special offers and promotional content</p>
                                                    </div>
                                                    <InputSwitch
                                                        checked={notifications.promotions}
                                                        onChange={(e) => setNotifications(prev => ({ ...prev, promotions: e.value }))}
                                                    />
                                                </div>

                                                <div className="flex align-items-center justify-content-between p-3 border-1 border-200 border-round">
                                                    <div className="flex-1">
                                                        <h5 className="font-semibold mb-1">Weekly Reports</h5>
                                                        <p className="text-600 text-sm">Get weekly summaries of your account activity</p>
                                                    </div>
                                                    <InputSwitch
                                                        checked={notifications.weeklyReports}
                                                        onChange={(e) => setNotifications(prev => ({ ...prev, weeklyReports: e.value }))}
                                                    />
                                                </div>
                                            </div>
