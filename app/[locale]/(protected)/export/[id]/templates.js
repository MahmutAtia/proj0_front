export const MOCK_TEMPLATES_WITH_THEMES = [
    {
    id: 't4',
    name: 'Minimal',
    value: 'template4',
    ...
    themes: [
      { name: 'Default', value: 'theme-default', color: '#2563eb' },
      { name: 'Stone', value: 'theme-stone', color: '#525252' },
      { name: 'Forest', value: 'theme-forest', color: '#059669' },
      { name: 'Ocean', value: 'theme-ocean', color: '#0ea5e9' },
    ],
    fonts: [
      { name: 'Nunito Sans + Source Serif', value: 'nunitosans-sourceserif', primary: 'Nunito Sans', secondary: 'Source Serif Pro', description: 'Clean and minimal' },
      { name: 'System UI + Georgia', value: 'system-georgia', primary: 'system-ui', secondary: 'Georgia', description: 'Native and simple' },
      { name: 'Inter + Charter', value: 'inter-charter', primary: 'Inter', secondary: 'Charter', description: 'Minimal perfection' },
      { name: 'Karla + Spectral', value: 'karla-spectral', primary: 'Karla', secondary: 'Spectral', description: 'Understated elegance' },
    ],
    ...
    themes: [
      { name: 'Default', value: 'theme-default', color: '#003399' },
      { name: 'Blue', value: 'theme-blue', color: '#0056b3' },
      { name: 'Green', value: 'theme-green', color: '#28a745' },
      { name: 'Grey', value: 'theme-grey', color: '#6c757d' },
    ],
    fonts: [
      { name: 'Source Sans Pro + Serif Pro', value: 'sourcesans-sourceserif', primary: 'Source Sans Pro', secondary: 'Source Serif Pro', description: 'Official EU style' },
      { name: 'Calibri + Times New Roman', value: 'calibri-times', primary: 'Calibri', secondary: 'Times New Roman', description: 'Classic document style' },
      { name: 'Arial + Georgia', value: 'arial-georgia', primary: 'Arial', secondary: 'Georgia', description: 'Traditional and formal' },
...

  {
    ...
    value: 'template_minimal3',
    previewUrl: '/templates/minimal3.jpg',
    themes: [
      { name: 'Slate Gray', value: 'theme-slate-gray', color: '#5d6d7e' },
      { name: 'Burgundy', value: 'theme-burgundy', color: '#88304e' },
      { name: 'Forest Green', value: 'theme-forest-green', color: '#2e8b57' },
      { name: 'Deep Purple', value: 'theme-deep-purple', color: '#6a0dad' },
    ],
    fonts: [
      { name: 'Fira Sans + Merriweather', value: 'fira-merriweather', primary: 'Fira Sans', secondary: 'Merriweather', description: 'Modern & classic' },
      { name: 'Lato + Roboto Slab', value: 'lato-roboto-slab', primary: 'Lato', secondary: 'Roboto Slab', description: 'Clean & sturdy' },
      { name: 'Inter + Lora', value: 'inter-lora', primary: 'Inter', secondary: 'Lora', description: 'Digital & elegant' },
      { name: 'Open Sans + Playfair', value: 'open-sans-playfair', primary: 'Open Sans', secondary: 'Playfair Display', description: 'Friendly & stylish' },
    ],
    defaultFont: 'fira-merriweather'
  },
  {
    id: 't6',
    name: 'Gridline Modern',
    value: 'template_minimal2',
    previewUrl: '/templates/minimal2.jpg',
    themes: [
      { name: 'Slate & Crimson', value: 'theme-slate-crimson', color: '#DC2626' },
      { name: 'Forest & Mint', value: 'theme-forest-mint', color: '#10B981' },
      { name: 'Midnight & Gold', value: 'theme-midnight-gold', color: '#D97706' },
    ],
    fonts: [
      { name: 'Roboto + Raleway', value: 'roboto-raleway', primary: 'Roboto', secondary: 'Raleway', description: 'Modern & geometric' },
      { name: 'Lato + Merriweather', value: 'lato-merriweather', primary: 'Lato', secondary: 'Merriweather', description: 'Classic & readable' },
      { name: 'Source Sans + Oswald', value: 'sourcesans-oswald', primary: 'Source Sans Pro', secondary: 'Oswald', description: 'Clean & bold' },
    ],
