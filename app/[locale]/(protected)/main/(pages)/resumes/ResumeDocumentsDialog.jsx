        ...
        <Dialog
            header={
                <div className="flex align-items-center">
                    ...
                    <span>
                        Documents for: <span className="font-semibold">{resume.title || 'Untitled Resume'}</span>
                    </span>
                </div>
            }
            visible={visible}
        ...
        >
            {documents.length > 0 ? (
                        ...
                        <li key={doc.unique_id} className="p-3 surface-card border-1 surface-border border-round flex flex-column sm:flex-row align-items-start sm:align-items-center justify-content-between gap-3 hover:shadow-1 transition-shadow">
                            <div className="flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span className="text-xs text-color-secondary">Created: {new Date(doc.created_at).toLocaleDateString()}</span>
                                </div>
                            </div>
                ...
                <div className="text-center p-5 my-3 bg-surface-ground border-round">
                    ...
                    <p className="text-sm text-color-secondary mb-4">This resume doesn&apos;t have any linked documents. You can create and manage documents in the resume editor.</p>
                    <Button
