...
export const metadata: Metadata = {
    ...
    keywords: ['AI resume builder', 'ATS resume checker', 'AI portfolio generator', 'job application help', 'career tools', 'AI cover letter generator', 'resume optimization', 'get past ATS', 'land interviews', 'job search AI'], // Added more variations
