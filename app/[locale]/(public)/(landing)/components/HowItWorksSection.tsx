...
const HowItWorksSection = () => {
    ...
    const steps = [
        { icon: FiUploadCloud, title: t('howItWorks.steps.input.title'), text: t('howItWorks.steps.input.text') },
        { icon: FiCpu, title: t('howItWorks.steps.aiMagic.title'), text: t('howItWorks.steps.aiMagic.text') },
        { icon: FiEdit, title: t('howItWorks.steps.refine.title'), text: t('howItWorks.steps.refine.text') }
    ];
    ...
    return (
        ...
        >
            <motion.div className={`${styles.textCenter} ${styles.marginBottom6}`} variants={fadeInUp} initial="initial" whileInView="animate" viewport={{ once: true }}>
                ...
                <p className={styles.subheading}>{t('howItWorks.subtitle')}</p>
            </motion.div>
